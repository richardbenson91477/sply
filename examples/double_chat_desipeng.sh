...
export ai2_desc_ai2="wants to design a single-file pygame using a prompt crafted by $ai1. It will have a modern and original design. $ai2 will try to be clear and concise with feature requests and when asking or answering follow-up questions"
